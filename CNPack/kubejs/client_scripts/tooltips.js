ItemEvents.tooltip(event => {
	...
	event.add('explorerscompass:explorerscompass', Text.of('§7§oCan locate very important structures!').color('#FFFFFF')); 
	event.add('explorerscompass:explorerscompass', Text.of('§8Uncraftable. Obtained from the quest §d"Finding Your Way"').color('#FFFFFF')); 
	...
	event.add('undergarden:droopvine_item', Text.of('\u00A7oCan be used to feed Old Toretoise').color('#FFFFFF'));
